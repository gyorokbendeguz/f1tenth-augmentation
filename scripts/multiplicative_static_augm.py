...
from f1tenth_augmentation.car_models import nonlinearCar_RK4
from model_augmentation.torch_nets import simple_res_net
from model_augmentation.augmentation_structures import get_augmented_fitsys, SSE_MultiplicativeAugmentation
...
bb_model = nonlinearCar_RK4(nx=n_out, ny=n_out, nu=2, ts=Ts, parmTune=bParmTune)

# Initialization
fit_sys = get_augmented_fitsys(augmentation_structure=SSE_MultiplicativeAugmentation, known_system=bb_model, wnet=ffw_net,
                               e_net=None, regLambda=regLambda, norm_data=train, norm_x0_meas=True)
...
augmentation_data = {
    "Augmentation": "STATIC MULTIPLICATIVE",
    "truncation time": T,
    "epochs": epoch,
